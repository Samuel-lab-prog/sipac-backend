...
import type { CommunicationsCommandsRepository, CreateAnnouncementParams } from '../../../ports/queries';
...
export function createAnnouncementFactory({ commandsRepository }: Dependencies) {
