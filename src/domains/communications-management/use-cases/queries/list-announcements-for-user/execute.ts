import type { AnnouncementListItem, CommunicationsQueriesRepository } from '../../../ports/queries';

type Dependencies = {
	queriesRepository: CommunicationsQueriesRepository;
};

export function listAnnouncementsForUserFactory({ queriesRepository }: Dependencies) {
