...
import { commandsRepository, queriesRepository } from './infra/repository/repository';
...
const listAnnouncementsForUser = listAnnouncementsForUserFactory({ queriesRepository });
